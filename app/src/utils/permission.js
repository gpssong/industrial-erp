...
const SENSITIVE_PAGES = new Set([
  ...
  '/pages/production/order-list',
  '/pages/production/order-detail',
  '/pages/product-add',
...
const PAGE_PERMS = {
  ...
  '/pages/production/order-list': 'production:order:list',
  '/pages/production/order-detail': 'production:order:list',
