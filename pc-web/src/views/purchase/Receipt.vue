      ...
      <el-form :model="form" label-width="100px">
        ...
        <el-form-item label="入库明细">
          ...
          <el-table :data="form.details" size="small" border style="margin-top:8px">
            ...
            <el-table-column v-if="taxSeparation === 'true'" label="税率" width="80"><template #default="{ row }"><el-input-number v-model="row.taxRate" :precision="4" size="small" /></template></el-table-column>
