    ...
    <el-dialog v-model="dialogVisible" :title="form.id ? '编辑BOM' : '新增BOM'" width="900px" destroy-on-close>
      <el-form :model="form" label-width="100px">
        ...
        <el-row :gutter="12">
          ...
          <el-col :span="8"><el-form-item label="损耗率%"><el-input-number v-model="form.lossRate" :min="0" :max="100" :precision="2" :step-strictly="false" style="width:100%" /></el-form-item></el-col>
