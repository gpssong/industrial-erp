    ...
    <el-dialog v-model="dialogVisible" :title="form.id ? '编辑出库单' : '新增销售出库单'" width="1100px" destroy-on-close>
      <el-form :model="form" label-width="100px" ref="formRef">
        ...
        <el-row :gutter="12">
          ...
          <el-col :span="6"><el-form-item label="整单折扣"><el-input-number v-model="form.discountAmount" :precision="4" /></el-form-item></el-col>
          <el-col :span="6"><el-form-item label="抹零"><el-input-number v-model="form.tailAmount" :precision="4" /></el-form-item></el-col>
        </el-row>
        ...
        <el-form-item label="商品明细">
          ...
          <el-table :data="form.details" size="small" border style="margin-top:8px" max-height="380">
            ...
            <el-table-column v-if="taxSeparation === 'true'" label="税率" width="80">
              <template #default="{ row }"><el-input-number v-model="row.taxRate" :precision="4" size="small" /></template>
            </el-table-column>
