  ...
  <div>
    ...
    <el-dialog v-model="dialogVisible" :title="form.id ? '编辑客户' : '新增客户'" width="700px" destroy-on-close>
      <el-form :model="form" label-width="100px">
        ...
        <el-row :gutter="12">
          <el-col :span="12"><el-form-item label="税率(%)"><el-input-number v-model="form.taxRate" :precision="2" :step-strictly="false" /></el-form-item></el-col>
          <el-col :span="12"><el-form-item label="税号"><el-input v-model="form.taxNo" /></el-form-item></el-col>
        </el-row>
        <el-row :gutter="12">
          <el-col :span="24"><el-form-item label="授信额度"><el-input-number v-model="form.creditLimit" :precision="2" :step-strictly="false" :min="0" /></el-form-item></el-col>
        </el-row>
