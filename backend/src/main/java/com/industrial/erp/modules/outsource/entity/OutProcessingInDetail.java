...
@TableName("out_processing_in_detail")
public class OutProcessingInDetail {
    ...
    public BigDecimal getProcessPrice() { return processPrice; }
    public void setProcessPrice(BigDecimal processPrice) { this.processPrice = processPrice; }
